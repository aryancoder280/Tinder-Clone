...
function Header(props) {
    ...
    return (
        <div className="header">
        {
           ...
           props.backButton ? (
                /* <Link to="/">
                <IconButton><ArrowBackIcon className="header__icon" fontSize="large"/>  </IconButton>
                </Link> *///this also works same ass below one
